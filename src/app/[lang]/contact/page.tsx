            ...
            <div className="mx-auto max-w-5xl px-6 pb-32 mt-12">
                ...
                <div className="rounded-[2.5rem] overflow-hidden border border-gray-100 dark:border-white/10 shadow-xl h-[450px] bg-gray-100 dark:bg-gray-800 relative group">
                    <iframe
                        ...
                        src="https://maps.google.com/maps?q=%EA%B3%A0%EC%96%91%EC%8B%9C%20%EB%8D%95%EC%96%91%EA%B5%AC%20%EB%8D%95%EC%9D%80%EB%8F%99%20692&t=&z=16&ie=UTF8&iwloc=&output=embed"
                        loading="lazy"
                        style={{ border: 0 }}
                        allowFullScreen
