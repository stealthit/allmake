...
export default function PortfolioClient({ dictionary, lang }: { dictionary: Record<string, any>, lang: string }) {
    ...
    const projects: { id: string; category: string; image: string; categoryKey: string }[] = [
        ...
        { id: "21", category: "Web", categoryKey: "web", image: "/images/portfolio-goldentree.png" },
        { id: "23", category: "UI/UX", categoryKey: "uiux", image: "/images/portfolio-seedgrow.jpg" },
        { id: "24", category: "Web", categoryKey: "web", image: "/images/portfolio-seah.png" },
        { id: "25", category: "Web", categoryKey: "web", image: "/images/portfolio-tcc-steel.jpg" },
