                ...
                <section className="relative overflow-hidden pt-20 pb-16 bg-white dark:bg-background-dark">
                    <div className="max-w-7xl mx-auto px-6 text-center">
                        ...
                        <p className="text-lg text-gray-500 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
                            STEALTH는 최신 기술 스택과 풍부한 경험을 바탕으로 비즈니스의 디지털 전환을 이끕니다.<br className="hidden md:block" />
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="grid md:grid-cols-2 gap-16 items-center">
                            <div className="order-2 md:order-1">
                                ...
                                <h2 className="text-3xl font-extrabold mb-4 text-deep-charcoal dark:text-white">AI & Data Solutions</h2>
                                <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                                    비즈니스의 지능화를 위한 전략적 AI 도입을 지원합니다. 최신 거대언어모델(LLM) 활용부터 커스텀 AI 모델링, 데이터 분석까지 기업의 경쟁력을 높이는 차세대 솔루션을 제공합니다.
                                </p>
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                                        ...
                                        <span>기업 전용 LLM 구축 및 서비스 연동</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                                        <span className="material-symbols-outlined text-primary font-bold">check</span>
                                        <span>머신러닝 기반 비즈니스 인사이트 도출</span>
                                    </div>
                                </div>
                            </div>
                ...
                <section className="mb-24 px-6">
                    <div className="max-w-7xl mx-auto bg-deep-charcoal dark:bg-gray-900 rounded-[2.5rem] p-12 md:p-20 relative overflow-hidden">
                        ...
                        <div className="relative z-10 text-center">
                            ...
                            <p className="text-gray-400 text-lg mb-12 max-w-2xl mx-auto">아이디어만 가져오셔도 좋습니다. STEALTH가 비즈니스의 성공적인 디지털 구현을 끝까지 책임집니다.</p>
                            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                                <Link href="/consultation" className="bg-primary text-deep-charcoal px-10 py-5 rounded-2xl font-bold text-xl hover:bg-white transition-colors w-full md:w-auto text-center">
                                    지금 바로 상담하기
                                </Link>
                                <Link href="/portfolio" className="border-2 border-gray-600 text-white px-10 py-5 rounded-2xl font-bold text-xl hover:border-primary transition-colors w-full md:w-auto text-center">
                                    포트폴리오 더보기
                                </Link>
                            </div>
                        </div>
