            ...
            <main>
                <section className="relative overflow-hidden pt-20 pb-24 md:pt-32 md:pb-32 bg-white dark:bg-background-dark">
                    <div className="max-w-7xl mx-auto px-6 text-center">
                        ...
                        <h1 className="text-4xl md:text-6xl font-black text-deep-charcoal dark:text-white leading-tight mb-8">
                            세상을 바꾸는 기술, <span className="text-primary">AllMake</span>
                        </h1>
                        <p className="text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
                            AllMake은 끊임없는 기술 혁신을 통해 디지털 미래를 선도합니다.<br className="hidden md:block" />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="bg-white dark:bg-gray-800 p-10 rounded-3xl border border-gray-100 dark:border-gray-700 text-center card-hover">
                                ...
                                <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
                                    신뢰를 최우선으로 생각하며 고객과의 파트너십을 소중히 여깁니다. 투명한 소통으로 최선의 결과를 약속합니다.
                                </p>
                            </div>
                            <div className="bg-white dark:bg-gray-800 p-10 rounded-3xl border border-gray-100 dark:border-gray-700 text-center card-hover">
                                <div className="w-20 h-20 bg-primary/10 rounded-full flex items-center justify-center text-primary mx-auto mb-8">
                                ...
                                <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
                                    기존의 틀을 깨는 혁신적인 사고로 새로운 디지털 가능성을 제시합니다. 최신 기술 트렌드를 선도합니다.
                                </p>
                            </div>
                            <div className="bg-white dark:bg-gray-800 p-10 rounded-3xl border border-gray-100 dark:border-gray-700 text-center card-hover">
                                <div className="w-20 h-20 bg-primary/10 rounded-full flex items-center justify-center text-primary mx-auto mb-8">
                                ...
                                <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
                                    고객사와 함께 성장하는 동반자로서 지속 가능한 비즈니스 성장을 위한 기술적 기반을 마련합니다.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-24 bg-white dark:bg-background-dark overflow-hidden">
                    <div className="max-w-4xl mx-auto px-6">
                        <div className="text-center mb-16">
                            ...
                            <h3 className="text-3xl md:text-4xl font-black text-deep-charcoal dark:text-white">AllMake의 발자취</h3>
                        </div>
                        <div className="relative">
                            ...
                            <div className="space-y-16">
                                <div className="relative flex flex-col md:flex-row items-center gap-8 md:gap-0">
                                    <div className="md:w-1/2 md:pr-12 text-left md:text-right order-2 md:order-1">
                                        <span className="text-primary font-black text-2xl">2024</span>
                                        <h4 className="text-xl font-bold mt-2">글로벌 시장 진출 및 서비스 확장</h4>
                                        <p className="text-gray-500 mt-2">동남아시아 및 북미 시장 파트너십 체결, AI 통합 개발 플랫폼 런칭</p>
                                    </div>
                                    <div className="absolute left-4 md:left-1/2 w-4 h-4 bg-primary rounded-full -translate-x-1/2 border-4 border-white dark:border-background-dark z-10"></div>
                                ...
                                <div className="relative flex flex-col md:flex-row items-center gap-8 md:gap-0">
                                    ...
                                    <div className="md:w-1/2 md:pl-12 text-left order-2">
                                        <span className="text-primary font-black text-2xl">2023</span>
                                        <h4 className="text-xl font-bold mt-2">블록체인 R&D 센터 설립</h4>
                                        <p className="text-gray-500 mt-2">Web3 전문 부서 신설 및 다수의 엔터프라이즈 블록체인 프로젝트 수주</p>
                                    </div>
                                </div>
                                <div className="relative flex flex-col md:flex-row items-center gap-8 md:gap-0">
                                    <div className="md:w-1/2 md:pr-12 text-left md:text-right order-2 md:order-1">
                                        <span className="text-primary font-black text-2xl">2022</span>
                                        <h4 className="text-xl font-bold mt-2">100번째 프로젝트 돌파</h4>
                                        <p className="text-gray-500 mt-2">누적 완료 프로젝트 100건 달성 및 고객 만족도 98% 기록</p>
                                    </div>
                                    <div className="absolute left-4 md:left-1/2 w-4 h-4 bg-primary rounded-full -translate-x-1/2 border-4 border-white dark:border-background-dark z-10"></div>
                                    <div className="md:w-1/2 md:pl-12 order-3"></div>
                                </div>
                                <div className="relative flex flex-col md:flex-row items-center gap-8 md:gap-0">
                                    ...
                                    <div className="absolute left-4 md:left-1/2 w-4 h-4 bg-primary rounded-full -translate-x-1/2 border-4 border-white dark:border-background-dark z-10"></div>
                                    <div className="md:w-1/2 md:pl-12 text-left order-2">
                                        <span className="text-primary font-black text-2xl">2021</span>
                                        <h4 className="text-xl font-bold mt-2">AllMake 법인 설립</h4>
                    ...
                    <div className="max-w-7xl mx-auto bg-deep-charcoal dark:bg-gray-900 rounded-[2.5rem] p-12 md:p-24 relative overflow-hidden">
                        ...
                        <div className="relative z-10 md:flex items-center justify-between gap-12">
                            <div className="max-w-xl">
                                <h2 className="text-4xl md:text-5xl font-black text-white mb-6">Ready to start your digital journey?</h2>
                                <p className="text-gray-400 text-lg mb-0">AllMake과 함께 당신의 비즈니스를 디지털 혁신으로 이끄세요.</p>
                            </div>
                            <div className="mt-10 md:mt-0 flex flex-col gap-4">
                                <button className="bg-primary text-deep-charcoal px-10 py-5 rounded-2xl font-bold text-xl hover:bg-white transition-all text-center mint-shadow">
                                    지금 바로 상담하기
                                </button>
