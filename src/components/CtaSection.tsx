            ...
            <div className="max-w-7xl mx-auto bg-deep-charcoal dark:bg-gray-900 rounded-[2.5rem] p-12 md:p-24 relative overflow-hidden">
                ...
                <div className="relative z-10 md:flex items-center justify-between gap-12">
                    <div className="max-w-xl">
                        <h2 className="text-2xl md:text-3xl font-black text-white mb-6">{dictionary.home.cta.title}</h2>
                        <p className="text-gray-400 text-lg mb-0">
                            {dictionary.home.cta.desc}
                        </p>
                    </div>
                    <div className="mt-10 md:mt-0 flex flex-col gap-4">
                        <Link href="/consultation" className="bg-primary text-deep-charcoal px-10 py-5 rounded-2xl font-bold text-xl hover:bg-white transition-colors text-center">
